...
import 'bootstrap/dist/css/bootstrap.min.css';
import DeviceService from '../services/DeviceService';
import '../DeviceManagementPage.css'; // Importing the same CSS file used for DeviceManagementPage
...
const LifecycleEventManagementPage = () => {
  ...
  return (
    <div className="container">
      <h2 className="page-title">Lifecycle Event Management</h2>
      <div className="card-container">
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            <label htmlFor="eventType" className="label-bold">Event Type:</label>
            <input type="text" className="form-control" id="eventType" name="eventType" value={newEvent.eventType} onChange={handleInputChange} required />
          </div>
          <div className="form-group">
            <label htmlFor="eventDate" className="label-bold">Event Date:</label>
            <input type="date" className="form-control" id="eventDate" name="eventDate" value={newEvent.eventDate} onChange={handleInputChange} required />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            <label htmlFor="selectedDeviceId" className="label-bold">Select Device:</label>
            <select
